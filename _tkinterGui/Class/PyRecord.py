...
class Records:
    ...
    def __init__(self):
        ...
        self.__wallet = 0
        self.__container = []
        self.showBox = []   # 用來裝要被顯示在 listBox 的東西
        try:   # 找不到檔案保持 empty，找到檔案則複製 container
    ...
    def Add(self, newRecord, categories):
        ...
        try:
            ...
            for data in newRecord:
                ...
                # if no date is found then set it to today, else check format
    ...
    def Find(self, SubsList):
        ...
        '''
        # save matched records in showBox
        self.showBox = [record for record in self.__container if record.category in SubsList]
